...
\\- New definitions for sounds \textit{(i\_soundids.inc)}
\\- Defined 1124 new game objects \textit{(i\_objects.inc)}
\\- Game objects are now in separate files according to their IDE files
\\- Game objects now use prefix \textit{OBJ\_}
\\- Updated documentation
\bigskip
\\\textbf{ISAMPP Sandbox Game Mode:}
\\- Phone pickup and 2 of 3 bottle pickups now work
\\- New command /cancelaction for disabling special actions 
