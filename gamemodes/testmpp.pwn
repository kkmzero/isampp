...
public OnGameModeInit()
{
	...
	CreatePickup(PICKUP_CORONA, PICKUP_TYPE_SCRIPTED, 325.5590, 2486.2830, 16.4844, -1);
	CreatePickup(PICKUP_CHECKPOINT, PICKUP_TYPE_SCRIPTED, 320.5590, 2486.2830, 16.4844, -1);
	CreatePickup(PICKUP_WHITEARROW, PICKUP_TYPE_SCRIPTED, 315.5590, 2486.2830, 16.4844, -1);
	CreatePickup(PICKUP_YELLOWARROW, PICKUP_TYPE_SCRIPTED, 310.5590, 2486.2830, 16.4844, -1);
	CreatePickup(PICKUP_PIZZABOX, PICKUP_TYPE_SCRIPTED, 305.5590, 2486.2830, 16.4844, -1);
	CreatePickup(PICKUP_RHYMEBOOK, PICKUP_TYPE_SCRIPTED, 300.5590, 2486.2830, 16.4844, -1);
	CreatePickup(PICKUP_CJAMMOBOX, PICKUP_TYPE_SCRIPTED, 295.5590, 2486.2830, 16.4844, -1);
	CreatePickup(PICKUP_CJSAWNOFF, PICKUP_TYPE_SCRIPTED, 290.5590, 2486.2830, 16.4844, -1);
	CreatePickup(PICKUP_CJSAWNOFF2, PICKUP_TYPE_SCRIPTED, 285.5590, 2486.2830, 16.4844, -1);
	CreatePickup(PICKUP_CJMP5, PICKUP_TYPE_SCRIPTED, 280.5590, 2486.2830, 16.4844, -1);
	CreatePickup(PICKUP_LOTION, PICKUP_TYPE_SCRIPTED, 275.5590, 2486.2830, 16.4844, -1);
	CreatePickup(PICKUP_PAINKILLER, PICKUP_TYPE_SCRIPTED, 270.5590, 2486.2830, 16.4844, -1);
	CreatePickup(PICKUP_WATCH, PICKUP_TYPE_SCRIPTED, 265.5590, 2486.2830, 16.4844, -1);
	CreatePickup(PICKUP_MINE, PICKUP_TYPE_SCRIPTED, 260.5590, 2486.2830, 16.4844, -1);
	CreatePickup(PICKUP_LANDMINE1, PICKUP_TYPE_SCRIPTED, 255.5590, 2486.2830, 16.4844, -1);
	CreatePickup(PICKUP_NOMODELFILE, PICKUP_TYPE_SCRIPTED, 250.5590, 2486.2830, 16.4844, -1);
	CreatePickup(PICKUP_MEDCASE, PICKUP_TYPE_SCRIPTED, 245.5590, 2486.2830, 16.4844, -1);
	CreatePickup(PICKUP_DYNAMITE, PICKUP_TYPE_SCRIPTED, 240.5590, 2486.2830, 16.4844, -1);
	CreatePickup(PICKUP_AIDKIT, PICKUP_TYPE_SCRIPTED, 235.5590, 2486.2830, 16.4844, -1);
	CreatePickup(PICKUP_AMMOBOX, PICKUP_TYPE_SCRIPTED, 230.5590, 2486.2830, 16.4844, -1);
	CreatePickup(PICKUP_PETROLCAN, PICKUP_TYPE_SCRIPTED, 225.5590, 2486.2830, 16.4844, -1);
	CreatePickup(PICKUP_GUNBOXSMALL, PICKUP_TYPE_SCRIPTED, 220.5590, 2486.2830, 16.4844, -1);
	CreatePickup(PICKUP_GUNBOXBIG, PICKUP_TYPE_SCRIPTED, 215.5590, 2486.2830, 16.4844, -1);
	...
	CreatePickup(PICKUP_NITRO2, PICKUP_TYPE_SCRIPTED, 180.5590, 2486.2830, 16.4844, -1);
	CreatePickup(PICKUP_NITRO3, PICKUP_TYPE_SCRIPTED, 175.5590, 2486.2830, 16.4844, -1);
	...
	//Add Static Vehicles
	AddStaticVehicle(VEH_BUFFALO, 425.7991, 2523.3472, 16.5794, 180, CARCOL_SAMP_BRIGHTGREEN, 0);
	AddStaticVehicle(VEH_PHOENIX, 420.7991, 2523.3472, 16.5764, 180, CARCOL_SAMP_SMOKEGREEN, 0);
	AddStaticVehicle(VEH_INFERNUS, 415.7991, 2523.3472, 16.5764, 180, CARCOL_SAMP_BRIGHTBEIGE, 0);
	AddStaticVehicle(VEH_BANSHEE, 410.7991, 2523.3472, 16.5764, 180, CARCOL_SAMP_BRIGHTINDIGO, 0);
	AddStaticVehicle(VEH_SULTAN, 405.7991, 2523.3472, 16.5764, 180, CARCOL_SAMP_LIGHTPINK, 0);
	AddStaticVehicle(VEH_RHINO, 271.9779, 2543.9709, 16.8211, 180, CARCOL_SAMP_BEIGE, 0);
	AddStaticVehicle(VEH_PACKER, 340.328, 2539.0764, 17.4211, 180, CARCOL_SAMP_BRONZE, 0);
	AddStaticVehicle(VEH_MONSTER, 393.1121, 2544.254, 16.909, 146.201, CARCOL_SAMP_GOLD, 0);
	AddStaticVehicle(VEH_QUAD, 414.1307, 2531.9279, 16, 188, 0, 0);
	AddStaticVehicle(VEH_CAMPER, 260.754821, 2547.231689, 16.710, 180, CARCOL_SAMP_LIGHTPURPLE, 0);
	AddStaticVehicle(VEH_TOWTRUCK, 384.848663, 2545.4951, 16.42258, 180, CARCOL_SAMP_LIME, 0);
	AddStaticVehicle(VEH_DUNE, 406.6405, 2542.84, 17.167, 155, CARCOL_SAMP_DEEPPURPLE, 0);
	AddStaticVehicle(VEH_SANCHEZ, 419.03, 2531.628, 16.2715, 220, CARCOL_SAMP_GREENBROWN, 0);
	AddStaticVehicle(VEH_BMX, 431.3886, 2538.52, 15.7283, 97.74, CARCOL_SAMP_PINE, 0);
	AddStaticVehicle(VEH_NRG500, 424.045, 2539.555, 16.0524, 272, CARCOL_SAMP_DARKENGREEN, 0);
	AddStaticVehicle(VEH_BF400, 421.9557, 2531.4655, 16.1991, 220, CARCOL_SAMP_BLUE, 0);
	AddStaticVehicle(VEH_RUSTLER, 350.9618, 2539.02, 17.445, 212.4, CARCOL_SAMP_GREEN, 0);
	AddStaticVehicle(VEH_SPARROW, 377.1873, 2537.1892, 16.5636, 180, CARCOL_SAMP_NEONGREEN, 0);
	AddStaticVehicle(VEH_MAVERICK, 365.3827, 2537.2888, 16.84, 180, CARCOL_SAMP_NEONCYAN, 0);
	AddStaticVehicle(VEH_HYDRA, 325.321166, 2539.4291, 17.53047, 180, CARCOL_SAMP_LIGHTBEIGE, 0);
	AddStaticVehicle(VEH_STUNTPLANE, 290.21, 2541.555, 17.5304, 180, CARCOL_SAMP_WHITESMOKE, 0);
