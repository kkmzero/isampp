...
public OnGameModeInit()
{
	...
	/*CreateObject(OBJECT_EXH_LR_T2, 425.5590, 2498.2830, 16.4844, 0.0, 0.0, 96.0);
	CreateObject(OBJECT_EXH_LR_T1, 420.5590, 2498.2830, 16.4844, 0.0, 0.0, 96.0);
	CreateObject(OBJECT_WG_R_LR_T1, 415.5590, 2498.2830, 16.4844, 0.0, 0.0, 96.0);
	CreateObject(OBJECT_SPL_A_S_B, 410.5590, 2498.2830, 16.4844, 0.0, 0.0, 96.0);
	CreateObject(OBJECT_SPL_C_S_B, 405.5590, 2498.2830, 16.4844, 0.0, 0.0, 96.0);
	CreateObject(OBJECT_RBMP_C_S, 400.5590, 2498.2830, 16.4844, 0.0, 0.0, 96.0);
	CreateObject(OBJECT_RBMP_A_S, 395.5590, 2498.2830, 16.4844, 0.0, 0.0, 96.0);
	CreateObject(OBJECT_BNTR_B_OV, 390.5590, 2498.2830, 16.4844, 0.0, 0.0, 96.0);*/
