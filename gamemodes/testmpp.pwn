...
{
	SetWorldTime(12);
	SetGameModeText("ISAMPP 1.8 Sandbox GameMode");
	...
	CreatePickup(PICKUP_HEART, PICKUP_TYPE_SCRIPTED, 410.5590, 2486.2830, 16.4844, -1);
	CreatePickup(PICKUP_PILL, PICKUP_TYPE_SCRIPTED, 405.5590, 2486.2830, 16.4844, -1);
	pickupArmor = CreatePickup(PICKUP_ARMOR, PICKUP_TYPE_RESPAWN_30S, 400.5590, 2486.2830, 16.4844, -1);
	CreatePickup(PICKUP_BRIBE, PICKUP_TYPE_SCRIPTED, 395.5590, 2486.2830, 16.4844, -1);
	CreatePickup(PICKUP_GTA3LOGO, PICKUP_TYPE_SCRIPTED, 390.5590, 2486.2830, 16.4844, -1);
	...
	CreatePickup(PICKUP_RAMPAGESSKULL, PICKUP_TYPE_SCRIPTED, 375.5590, 2486.2830, 16.4844, -1);
	CreatePickup(PICKUP_RAMPAGEMSKULL, PICKUP_TYPE_SCRIPTED, 370.5590, 2486.2830, 16.4844, -1);
	CreatePickup(PICKUP_PROPERTYBLUE, PICKUP_TYPE_SCRIPTED, 365.5590, 2486.2830, 16.4844, -1);
	CreatePickup(PICKUP_PROPERTYGRN, PICKUP_TYPE_SCRIPTED, 360.5590, 2486.2830, 16.4844, -1);
	CreatePickup(PICKUP_DOLLAR, PICKUP_TYPE_SCRIPTED, 355.5590, 2486.2830, 16.4844, -1);
	CreatePickup(PICKUP_BLSHIRT, PICKUP_TYPE_SCRIPTED, 350.5590, 2486.2830, 16.4844, -1);
	...
	CreatePickup(PICKUP_DRUGS, PICKUP_TYPE_SCRIPTED, 335.5590, 2486.2830, 16.4844, -1);
	...
	CreatePickup(PICKUP_YELLOWBOTTLE, PICKUP_TYPE_SCRIPTED, 275.5590, 2486.2830, 16.4844, -1);
	...
	CreatePickup(PICKUP_LANDMINE, PICKUP_TYPE_SCRIPTED, 260.5590, 2486.2830, 16.4844, -1);
	CreatePickup(PICKUP_LANDMINE2, PICKUP_TYPE_SCRIPTED, 255.5590, 2486.2830, 16.4844, -1);
	CreatePickup(PICKUP_STRIPEDQUESTIONM, PICKUP_TYPE_SCRIPTED, 250.5590, 2486.2830, 16.4844, -1);
	...
	CreatePickup(PICKUP_REDARROWDOWN, PICKUP_TYPE_SCRIPTED, 320.5590, 2492.2830, 16.4844, -1);
	CreatePickup(PICKUP_RUSTYM4, PICKUP_TYPE_SCRIPTED, 315.5590, 2492.2830, 16.4844, -1);
	...
	CreatePickup(PICKUP_SQUARESHOVEL, PICKUP_TYPE_SCRIPTED, 295.5590, 2492.2830, 16.4844, -1);
	CreatePickup(PICKUP_PAPERTARGETS, PICKUP_TYPE_SCRIPTED, 290.5590, 2492.2830, 16.4844, -1);
	CreatePickup(PICKUP_RUSTYSNIPER, PICKUP_TYPE_SCRIPTED, 285.5590, 2492.2830, 16.4844, -1);
	...
	CreatePickup(PICKUP_YELLOWENMARKER, PICKUP_TYPE_SCRIPTED, 265.5590, 2492.2830, 16.4844, -1);
...
public OnPlayerConnect(playerid)
{
	switch(ISAMPP_VERID) {
		...
		case 202118: SendClientMessage(playerid, COLOR_MAGENTA, "ISAMPP 1.8");
